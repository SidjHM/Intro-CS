...
float kittyEyesOffset = 0.2;
float kittyEyesDx = 0.2;

int isCat = (int) random(2); 
int characters=(int)random(2);
/* 
...
for(int i = 1; i <= 11; i = i + 1) {
    ...
    if (characters == 0){
    tower(i*130, (int) random(200,700), 200, "kitty", color(124, 166, 233));
    } else if (characters == 1){
     tower(i*130, (int) random(200,700), 200, "person", color(222, 135, 12));
    }
  }
  
  if (frameCount % 10 == 0) {
    characters = (int) random(2);
